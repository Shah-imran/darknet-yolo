...
- each: `model of object, side, illumination, scale, each 30 grad` of the turn and inclination angles - these are _different objects_ from an internal perspective of the neural network. So the more _different objects_ you want to detect, the more complex network model should be used.
...
> > > > > > > ae759d3fc6ce73527b2fe33bc24a55c58f9dcc6b
